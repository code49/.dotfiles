...

{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      rb = "printf 'manually-requested REBOOT in 1 second; \`ctrl + c\` or otherwise destroy this terminal window to cancel this operation.\n'; sleep 1; reboot"; # quickly reboot the system
      sd = "printf 'manually-requested SHUTDOWN in 1 second; \`ctrl + c\` or otherwise destroy this terminal window to cancel this operation.\n'; sleep 1; shutdown now"; # add delay for shutdown-ing
